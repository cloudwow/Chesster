...
public class ScoreTables {
  ...
  public static final int KingValue = 20000;

  public static final int[] blackPawnSquareTable = new int[]
      {
  ...
  public static final int[] whitePawnSquareTable = new int[]
      {
  ...
  public static final int[] blackKnightSquareTable = new int[]
      {
  ...
  public static final int[] whiteKnightSquareTable = new int[]
      {
  ...
  public static final int[] blackBishopSquareTable = new int[]
      {
  ...
  public static final int[] whiteBishopSquareTable = new int[]
      {
  ...
  public static final int[] blackRookSquareTable = new int[]
      {
  ...
  public static final int[] whiteRookSquareTable = new int[]
      {
    0, 0, 0, 5, 5, 0, 0, 0, -5, 0, 0, 0, 0, 0, 0, -5, -5, 0, 0, 0, 0, 0, 0, -5, -5, 0, 0, 0, 0, 0, 0,
    -5, -5, 0, 0, 0, 0, 0, 0, -5, -5, 0, 0, 0, 0, 0, 0, -5, 5, 10, 10, 10, 10, 10, 10, 5, 0, 0, 0, 0,
    0, 0, 0, 0,
  };

  public static final int[] blackQueenSquareTable = new int[]
      {
  ...
  public static final int[] whiteQueenSquareTable = new int[]
      {
  ...
  public static final int[] blackKingMiddleGameSquareTable = new int[]
      {
  ...
  public static final int[] whiteKingMiddleGameSquareTable = new int[]
      {
  ...
  public static final int[] blackKingEndGameSquareTable = new int[]
      {
  ...
  public static final int[] whiteKingEndGameSquareTable = new int[]
      {
    -50, -30, -30, -30, -30, -30, -30, -50, -30, -30, 0, 0, 0, 0, -30, -30, -30, -10, 20, 30, 30, 20,
    -10, -30, -30, -10, 30, 40, 40, 30, -10, -30, -30, -10, 30, 40, 40, 30, -10, -30, -30, -10, 20,
